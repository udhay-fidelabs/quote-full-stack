    ...
    <Card>
      <BlockStack gap="400">
          ...
          <BlockStack gap="400">
            ...
            <BlockStack gap="300">
              ...
              {!settings.hidePriceGlobal && (
                <Text variant="headingLg" fontWeight="bold" as="p" tone="subdued">
                  $1,725.00
                </Text>
              )}
              ...
              <BlockStack gap="300">
                ...
                {(settings.placementLocation === 'below' || !settings.placementLocation) &&
                  settings.appEnabled && (
                    <div
                      style={{
                        width: '100%',
        ...
        <Text as="p" variant="bodySm" tone="subdued" alignment="center">
          This is a mock representation of how your storefront will appear according to your current
          configuration.
        </Text>
      </BlockStack>
    </Card>
