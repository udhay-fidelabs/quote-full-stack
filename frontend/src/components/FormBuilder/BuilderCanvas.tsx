...
import { FIELD_OPTIONS, getStandardFields, TYPE_LABEL } from './BuilderCanvas.utils';
    ...
    <div className="p-8 max-w-4xl mx-auto space-y-12 animate-fadeIn pb-32">
      <header className="flex flex-col gap-2">
        ...
        <Text variant="bodyMd" as="p" tone="subdued">
          Organize your form into logical sections. Add fields to each section and reorder them as
          needed.
        </Text>
      </header>
      ...
      <div className="space-y-10">
        {formState.steps.map((step) => (
          <div
            key={step.id}
            className="rq-builder-section bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col"
          >
            {/* Section Header */}
            <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
              ...
              <Button variant="tertiary" size="slim" onClick={() => resetToStandard(step.id)}>
      ...
      <div className="flex items-center p-4 gap-4">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-[2fr_1fr_auto] items-center gap-6">
          ...
          <div className="flex items-center justify-end">
            <Button icon={DeleteIcon} tone="critical" variant="tertiary" onClick={onRemove} />
          </div>
        </div>
      </div>
    </div>
