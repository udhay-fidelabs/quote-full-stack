...
export const PlansBanners: React.FC<PlansBannersProps> = ({
  ...
  return (
    <>
      {showSuccessBanner && (
        <Layout.Section>
          <Banner tone="success" onDismiss={onDismissSuccess} title="Plan updated">
      ...
      {showErrorBanner && (
        <Layout.Section>
          <Banner tone="critical" onDismiss={onDismissError} title="Upgrade failed">
      ...
      {upgradeError && (
        <Layout.Section>
          <Banner tone="critical" title="Upgrade Error" onDismiss={onDismissUpgradeError}>
            <p>{upgradeError}</p>
          </Banner>
        </Layout.Section>
      )}
