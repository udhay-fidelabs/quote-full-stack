          ...
          <InlineStack align="space-between" blockAlign="center">
            ...
            <InlineStack gap="300" blockAlign="center">
              ...
              <Popover
                ...
                activator={
                  <Button onClick={togglePopover} disclosure variant="tertiary" size="slim">
          ...
          <InlineStack gap="600" align="center">
            <BlockStack gap="100" align="center">
              ...
              <Text variant="headingMd" as="p">
                {allTimeStats.totalQuotes}
              </Text>
            </BlockStack>
            <div
              style={{ width: '1px', height: '24px', background: 'var(--p-color-border-subdued)' }}
            />
            <BlockStack gap="100" align="center">
              <Text variant="bodySm" as="p" tone="subdued">
                TOTAL CONVERTED
            ...
            <BlockStack gap="100" align="center">
              ...
              <Text variant="headingMd" as="p">
                ${(allTimeStats.yearAmount / 100).toFixed(2)}
              </Text>
            </BlockStack>
          </InlineStack>
        </BlockStack>
