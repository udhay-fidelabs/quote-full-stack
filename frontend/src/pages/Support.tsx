...
import { ChatIcon, EmailIcon, ExternalIcon, PersonIcon } from '@shopify/polaris-icons';
          ...
          <Layout.Section>
            <BlockStack gap="400">
              <Card>
                <BlockStack gap="400">
                  ...
                  <Text as="p" variant="bodyMd" tone="subdued">
                    This page provides guidance on using the app features, including the Request
                    Quote Button, Custom Form Builder, and Quote Management System.
                  </Text>
                  <Text as="p" variant="bodyMd" tone="subdued">
                    If you need additional assistance, you can follow the documentation below or
              ...
              <Card>
                <BlockStack gap="400">
                  <Text as="h2" variant="headingMd">
                    How to show Quote Button on your product page
                  </Text>
                  <BlockStack gap="300">
                    <BlockStack gap="100">
                      ...
                      <List>
                        <List.Item>
                          Go to your{' '}
                          <Link url="shopify:admin/themes/current/editor" external>
                    ...
                    <BlockStack gap="100">
                      <Text as="h3" variant="headingSm" fontWeight="medium">
                        Sections/Blocks (Custom Placement)
                      </Text>
                      <Text as="p" tone="subdued">
                        Use this if you want to place the button at a specific location on your
                        product template.
                      </Text>
                      <List>
                        <List.Item>Open the theme editor and navigate to a product page.</List.Item>
                        <List.Item>
